  ...
  return (
    <div className="bg-[#FAFAF9]">
      ...
      <section className="py-32 md:py-40 bg-white">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          <h2 className="text-xs font-medium tracking-[0.3em] uppercase text-neutral-500 mb-24">Corporate Services</h2>
          
          <div className="grid md:grid-cols-2 gap-20">
            <div>
              <h3 className="text-3xl font-light text-neutral-900 mb-8 tracking-tight">
                Fraud & Risk Management
              </h3>
              <ul className="space-y-4 text-neutral-600 font-light leading-relaxed">
      ...
      <section className="py-32 md:py-40 bg-neutral-900">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          <h2 className="text-xs font-medium tracking-[0.3em] uppercase text-neutral-500 mb-24">Why Trust Monaco PI</h2>
